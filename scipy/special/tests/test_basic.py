...
class TestCephes(TestCase):
    ...
    def test_smirnov(self):
        ...
        assert_equal(cephes.smirnov(1,0.875),0.125)
        assert_equal(cephes.smirnov(2,0.875),0.125*0.125)
        assert_equal(cephes.smirnov(3,.875),0.125*0.125*0.125)
        assert_almost_equal(cephes.smirnov(1, 0.5), 0.5)
        assert_almost_equal(cephes.smirnov(2, 0.5), 0.25)
        assert_almost_equal(cephes.smirnov(3, 0.5), 0.166666666667)
        assert_almost_equal(cephes.smirnov(4, 0.5), 0.09375)
        assert_almost_equal(cephes.smirnov(5, 0.5), 0.056)
        assert_almost_equal(cephes.smirnov(6, 0.5), 0.0327932098765)
        assert_almost_equal(cephes.smirnov(7, 0.5), 0.0191958707681)
        assert_almost_equal(cephes.smirnov(8, 0.5), 0.0112953186035)
        assert_almost_equal(cephes.smirnov(9, 0.5), 0.00661933257355)
        assert_almost_equal(cephes.smirnov(10, 0.5), 0.003888705)
    ...
    def test_smirnovi(self):
        ...
        assert_almost_equal(cephes.smirnov(2,cephes.smirnovi(2,0.875)),0.875)
        assert_almost_equal(cephes.smirnov(3,cephes.smirnovi(3,0.875)),0.875)
        assert_almost_equal(cephes.smirnov(3,cephes.smirnovi(3,0.125)),0.125)
        assert_almost_equal(cephes.smirnov(10,cephes.smirnovi(10,0.999)),0.999)
        assert_almost_equal(cephes.smirnovi(10,cephes.smirnov(10,0.0001)),0.0001)
        assert_(np.isnan(cephes.smirnovi(1,np.nan)))
        assert_almost_equal(cephes.smirnovi(1, 0.5), 0.5)
        assert_almost_equal(cephes.smirnovi(2, 0.5), 0.366025403784)
        assert_almost_equal(cephes.smirnovi(3, 0.5), 0.297156508177)
        assert_almost_equal(cephes.smirnovi(4, 0.5), 0.255520481121)
        assert_almost_equal(cephes.smirnovi(5, 0.5), 0.234559536069)
        assert_almost_equal(cephes.smirnovi(6, 0.5), 0.21715965898)
        assert_almost_equal(cephes.smirnovi(7, 0.5), 0.202722580034)
        assert_almost_equal(cephes.smirnovi(8, 0.5), 0.190621765256)
        assert_almost_equal(cephes.smirnovi(9, 0.5), 0.180363501362)
        assert_almost_equal(cephes.smirnovi(10, 0.5), 0.17157867006)

    def test_smirnovp(self):
        assert_equal(cephes.smirnovp(1,0),-1)
        assert_equal(cephes.smirnovp(1,1),-1)
        assert_(np.isnan(cephes.smirnovp(1,np.nan)))
        assert_equal(cephes.smirnovp(2,0.875),-0.25)
        assert_equal(cephes.smirnovp(2,0.125),-1.250)
        assert_equal(cephes.smirnovp(2,0.75),-0.5)
        assert_equal(cephes.smirnovp(3,0.75),-0.1875)
        assert_equal(cephes.smirnovp(4,0.75),-0.0625)
        assert_almost_equal(cephes.smirnovp(1, 0.5), -1.0)
        assert_almost_equal(cephes.smirnovp(2, 0.5), -1.0)
        assert_almost_equal(cephes.smirnovp(3, 0.5), -1.16666666667)
        assert_almost_equal(cephes.smirnovp(4, 0.5), -0.8125)
        assert_almost_equal(cephes.smirnovp(5, 0.5), -0.663)
        assert_almost_equal(cephes.smirnovp(6, 0.5), -0.448302469136)
        assert_almost_equal(cephes.smirnovp(7, 0.5), -0.312009133099)
        assert_almost_equal(cephes.smirnovp(8, 0.5), -0.208366394043)
        assert_almost_equal(cephes.smirnovp(9, 0.5), -0.137201408986)
        assert_almost_equal(cephes.smirnovp(10, 0.5), -0.08959009)
